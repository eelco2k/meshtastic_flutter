...
class OTAMode extends $pb.ProtobufEnum {
  static const OTAMode NO_REBOOT_OTA = OTAMode._(0, _omitEnumNames ? '' : 'NO_REBOOT_OTA');
  static const OTAMode OTA_BLE = OTAMode._(1, _omitEnumNames ? '' : 'OTA_BLE');
  static const OTAMode OTA_WIFI = OTAMode._(2, _omitEnumNames ? '' : 'OTA_WIFI');
  ...
  static final $core.Map<$core.int, OTAMode> _byValue = $pb.ProtobufEnum.initByValue(values);
  static OTAMode? valueOf($core.int value) => _byValue[value];

  const OTAMode._($core.int v, $core.String n) : super(v, n);
}
...
class AdminMessage_ModuleConfigType extends $pb.ProtobufEnum {
  ...
  static const AdminMessage_ModuleConfigType STATUSMESSAGE_CONFIG = AdminMessage_ModuleConfigType._(13, _omitEnumNames ? '' : 'STATUSMESSAGE_CONFIG');
  static const AdminMessage_ModuleConfigType TRAFFICMANAGEMENT_CONFIG = AdminMessage_ModuleConfigType._(14, _omitEnumNames ? '' : 'TRAFFICMANAGEMENT_CONFIG');
  static const AdminMessage_ModuleConfigType TAK_CONFIG = AdminMessage_ModuleConfigType._(15, _omitEnumNames ? '' : 'TAK_CONFIG');

...
class ServiceEnvelope extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServiceEnvelope', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..aOM<$8.MeshPacket>(1, _omitFieldNames ? '' : 'packet', subBuilder: $8.MeshPacket.create)
  ...
  @$pb.TagNumber(1)
  $8.MeshPacket get packet => $_getN(0);
  @$pb.TagNumber(1)
  set packet($8.MeshPacket v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPacket() => $_has(0);
  @$pb.TagNumber(1)
  void clearPacket() => clearField(1);
  @$pb.TagNumber(1)
  $8.MeshPacket ensurePacket() => $_ensure(0);
...
class MapReport extends $pb.GeneratedMessage {
  factory MapReport({
    ...
    $3.Config_LoRaConfig_RegionCode? region,
    $3.Config_LoRaConfig_ModemPreset? modemPreset,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MapReport', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ...
    ..e<$3.Config_DeviceConfig_Role>(3, _omitFieldNames ? '' : 'role', $pb.PbFieldType.OE, defaultOrMaker: $3.Config_DeviceConfig_Role.CLIENT, valueOf: $3.Config_DeviceConfig_Role.valueOf, enumValues: $3.Config_DeviceConfig_Role.values)
    ...
    ..e<$3.Config_LoRaConfig_RegionCode>(6, _omitFieldNames ? '' : 'region', $pb.PbFieldType.OE, defaultOrMaker: $3.Config_LoRaConfig_RegionCode.UNSET, valueOf: $3.Config_LoRaConfig_RegionCode.valueOf, enumValues: $3.Config_LoRaConfig_RegionCode.values)
    ..e<$3.Config_LoRaConfig_ModemPreset>(7, _omitFieldNames ? '' : 'modemPreset', $pb.PbFieldType.OE, defaultOrMaker: $3.Config_LoRaConfig_ModemPreset.LONG_FAST, valueOf: $3.Config_LoRaConfig_ModemPreset.valueOf, enumValues: $3.Config_LoRaConfig_ModemPreset.values)
  ...
  @$pb.TagNumber(3)
  $3.Config_DeviceConfig_Role get role => $_getN(2);
  @$pb.TagNumber(3)
  set role($3.Config_DeviceConfig_Role v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(6)
  $3.Config_LoRaConfig_RegionCode get region => $_getN(5);
  @$pb.TagNumber(6)
  set region($3.Config_LoRaConfig_RegionCode v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  $3.Config_LoRaConfig_ModemPreset get modemPreset => $_getN(6);
  @$pb.TagNumber(7)
  set modemPreset($3.Config_LoRaConfig_ModemPreset v) { setField(7, v); }
  @$pb.TagNumber(7)

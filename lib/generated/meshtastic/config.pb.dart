...
class Config_DisplayConfig extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(14)
  set enableMessageBubbles($core.bool v) { $_setBool(13, v); }
  @$pb.TagNumber(14)
  $core.bool hasEnableMessageBubbles() => $_has(13);
  @$pb.TagNumber(14)
  void clearEnableMessageBubbles() => clearField(14);
}
...
class Config_LoRaConfig extends $pb.GeneratedMessage {
  factory Config_LoRaConfig({
    ...
    if (femLnaMode != null) {
      $result.femLnaMode = femLnaMode;
    }
    if (serialHalOnly != null) {
      $result.serialHalOnly = serialHalOnly;
    }
    return $result;
  }
  ...
  @$pb.TagNumber(106)
  set femLnaMode(Config_LoRaConfig_FEM_LNA_Mode v) { setField(106, v); }
  @$pb.TagNumber(106)
  $core.bool hasFemLnaMode() => $_has(18);
  @$pb.TagNumber(106)
  void clearFemLnaMode() => clearField(106);
  ...
  @$pb.TagNumber(107)
  set serialHalOnly($core.bool v) { $_setBool(19, v); }
  @$pb.TagNumber(107)
  $core.bool hasSerialHalOnly() => $_has(19);
  @$pb.TagNumber(107)
  void clearSerialHalOnly() => clearField(107);
}

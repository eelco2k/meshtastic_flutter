...
class DeviceProfile extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeviceProfile', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ...
    ..aOM<$10.LocalConfig>(4, _omitFieldNames ? '' : 'config', subBuilder: $10.LocalConfig.create)
    ..aOM<$10.LocalModuleConfig>(5, _omitFieldNames ? '' : 'moduleConfig', subBuilder: $10.LocalModuleConfig.create)
    ..aOM<$8.Position>(6, _omitFieldNames ? '' : 'fixedPosition', subBuilder: $8.Position.create)
  ...
  @$pb.TagNumber(4)
  $10.LocalConfig get config => $_getN(3);
  @$pb.TagNumber(4)
  set config($10.LocalConfig v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasConfig() => $_has(3);
  @$pb.TagNumber(4)
  void clearConfig() => clearField(4);
  @$pb.TagNumber(4)
  $10.LocalConfig ensureConfig() => $_ensure(3);

  ///
  ///  The ModuleConfig of the node
  @$pb.TagNumber(5)
  $10.LocalModuleConfig get moduleConfig => $_getN(4);
  @$pb.TagNumber(5)
  set moduleConfig($10.LocalModuleConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasModuleConfig() => $_has(4);
  @$pb.TagNumber(5)
  void clearModuleConfig() => clearField(5);
  @$pb.TagNumber(5)
  $10.LocalModuleConfig ensureModuleConfig() => $_ensure(4);

  ///
  ///  Fixed position data
  @$pb.TagNumber(6)
  $8.Position get fixedPosition => $_getN(5);
  @$pb.TagNumber(6)
  set fixedPosition($8.Position v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasFixedPosition() => $_has(5);
  @$pb.TagNumber(6)
  void clearFixedPosition() => clearField(6);
  @$pb.TagNumber(6)
  $8.Position ensureFixedPosition() => $_ensure(5);

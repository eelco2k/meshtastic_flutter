...
class HardwareModel extends $pb.ProtobufEnum {
  ...
  static const HardwareModel TRACKER_T1000_E_PRO = HardwareModel._(128, _omitEnumNames ? '' : 'TRACKER_T1000_E_PRO');
...
class StoreForwardPlusPlus_SFPP_message_type extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, StoreForwardPlusPlus_SFPP_message_type> _byValue = $pb.ProtobufEnum.initByValue(values);
  static StoreForwardPlusPlus_SFPP_message_type? valueOf($core.int value) => _byValue[value];

  const StoreForwardPlusPlus_SFPP_message_type._($core.int v, $core.String n) : super(v, n);
}
...
class RemoteShell_OpCode extends $pb.ProtobufEnum {
  ...
  const RemoteShell_OpCode._($core.int v, $core.String n) : super(v, n);
}
...
class LockdownStatus_State extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, LockdownStatus_State> _byValue = $pb.ProtobufEnum.initByValue(values);
  static LockdownStatus_State? valueOf($core.int value) => _byValue[value];

  const LockdownStatus_State._($core.int v, $core.String n) : super(v, n);
}

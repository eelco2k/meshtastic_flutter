...
class Config_LoRaConfig_FEM_LNA_Mode extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, Config_LoRaConfig_FEM_LNA_Mode> _byValue = $pb.ProtobufEnum.initByValue(values);
  static Config_LoRaConfig_FEM_LNA_Mode? valueOf($core.int value) => _byValue[value];

  const Config_LoRaConfig_FEM_LNA_Mode._($core.int v, $core.String n) : super(v, n);
}

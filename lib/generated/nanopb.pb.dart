...
class NanoPBOptions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NanoPBOptions', createEmptyInstance: create)
    ...
    ..e<$0.FieldDescriptorProto_Type>(27, _omitFieldNames ? '' : 'typeOverride', $pb.PbFieldType.OE, defaultOrMaker: $0.FieldDescriptorProto_Type.TYPE_DOUBLE, valueOf: $0.FieldDescriptorProto_Type.valueOf, enumValues: $0.FieldDescriptorProto_Type.values)
  ...
  @$pb.TagNumber(27)
  set typeOverride($0.FieldDescriptorProto_Type v) { setField(27, v); }
  @$pb.TagNumber(27)

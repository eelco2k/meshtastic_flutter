...
class ModuleConfig_TrafficManagementConfig extends $pb.GeneratedMessage {
  factory ModuleConfig_TrafficManagementConfig({
    ...
    if (rateLimitEnabled != null) {
      $result.rateLimitEnabled = rateLimitEnabled;
    }
  ...
  ModuleConfig_TrafficManagementConfig._() : super();
  factory ModuleConfig_TrafficManagementConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ModuleConfig_TrafficManagementConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModuleConfig.TrafficManagementConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ...
    ..a<$core.int>(3, _omitFieldNames ? '' : 'positionPrecisionBits', $pb.PbFieldType.OU3)
  ...
  @$pb.TagNumber(2)
  set positionDedupEnabled($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasPositionDedupEnabled() => $_has(1);
  @$pb.TagNumber(2)
  void clearPositionDedupEnabled() => clearField(2);
  ...
  @$pb.TagNumber(3)
  set positionPrecisionBits($core.int v) { $_setUnsignedInt32(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasPositionPrecisionBits() => $_has(2);
  @$pb.TagNumber(3)
  void clearPositionPrecisionBits() => clearField(3);
  ...
  @$pb.TagNumber(4)
  set positionMinIntervalSecs($core.int v) { $_setUnsignedInt32(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasPositionMinIntervalSecs() => $_has(3);
  @$pb.TagNumber(4)
  void clearPositionMinIntervalSecs() => clearField(4);
  ...
  @$pb.TagNumber(5)
  set nodeinfoDirectResponse($core.bool v) { $_setBool(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasNodeinfoDirectResponse() => $_has(4);
  @$pb.TagNumber(5)
  void clearNodeinfoDirectResponse() => clearField(5);
  ...
  @$pb.TagNumber(6)
  set nodeinfoDirectResponseMaxHops($core.int v) { $_setUnsignedInt32(5, v); }
  @$pb.TagNumber(6)
  $core.bool hasNodeinfoDirectResponseMaxHops() => $_has(5);
  @$pb.TagNumber(6)
  void clearNodeinfoDirectResponseMaxHops() => clearField(6);
  ...
  @$pb.TagNumber(7)
  set rateLimitEnabled($core.bool v) { $_setBool(6, v); }
  @$pb.TagNumber(7)
  $core.bool hasRateLimitEnabled() => $_has(6);
  @$pb.TagNumber(7)
  void clearRateLimitEnabled() => clearField(7);
  ...
  @$pb.TagNumber(8)
  set rateLimitWindowSecs($core.int v) { $_setUnsignedInt32(7, v); }
  @$pb.TagNumber(8)
  $core.bool hasRateLimitWindowSecs() => $_has(7);
  @$pb.TagNumber(8)
  void clearRateLimitWindowSecs() => clearField(8);
  ...
  @$pb.TagNumber(9)
  set rateLimitMaxPackets($core.int v) { $_setUnsignedInt32(8, v); }
  @$pb.TagNumber(9)
  $core.bool hasRateLimitMaxPackets() => $_has(8);
  @$pb.TagNumber(9)
  void clearRateLimitMaxPackets() => clearField(9);
  ...
  @$pb.TagNumber(10)
  set dropUnknownEnabled($core.bool v) { $_setBool(9, v); }
  @$pb.TagNumber(10)
  $core.bool hasDropUnknownEnabled() => $_has(9);
  @$pb.TagNumber(10)
  void clearDropUnknownEnabled() => clearField(10);
  ...
  @$pb.TagNumber(11)
  set unknownPacketThreshold($core.int v) { $_setUnsignedInt32(10, v); }
  @$pb.TagNumber(11)
  $core.bool hasUnknownPacketThreshold() => $_has(10);
  @$pb.TagNumber(11)
  void clearUnknownPacketThreshold() => clearField(11);
  ...
  @$pb.TagNumber(12)
  set exhaustHopTelemetry($core.bool v) { $_setBool(11, v); }
  @$pb.TagNumber(12)
  $core.bool hasExhaustHopTelemetry() => $_has(11);
  @$pb.TagNumber(12)
  void clearExhaustHopTelemetry() => clearField(12);
  ...
  @$pb.TagNumber(13)
  set exhaustHopPosition($core.bool v) { $_setBool(12, v); }
  @$pb.TagNumber(13)
  $core.bool hasExhaustHopPosition() => $_has(12);
  @$pb.TagNumber(13)
  void clearExhaustHopPosition() => clearField(13);
  ...
  @$pb.TagNumber(14)
  set routerPreserveHops($core.bool v) { $_setBool(13, v); }
  @$pb.TagNumber(14)
  $core.bool hasRouterPreserveHops() => $_has(13);
  @$pb.TagNumber(14)
  void clearRouterPreserveHops() => clearField(14);
}
...
class ModuleConfig_TelemetryConfig extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(15)
  set airQualityScreenEnabled($core.bool v) { $_setBool(14, v); }
  @$pb.TagNumber(15)
  $core.bool hasAirQualityScreenEnabled() => $_has(14);
  @$pb.TagNumber(15)
  void clearAirQualityScreenEnabled() => clearField(15);
}
...
class ModuleConfig_StatusMessageConfig extends $pb.GeneratedMessage {
  ...
  ModuleConfig_StatusMessageConfig._() : super();
  factory ModuleConfig_StatusMessageConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ModuleConfig_StatusMessageConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  @$pb.TagNumber(1)
  set nodeStatus($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasNodeStatus() => $_has(0);
  @$pb.TagNumber(1)
  void clearNodeStatus() => clearField(1);
}
...
class ModuleConfig_TAKConfig extends $pb.GeneratedMessage {
  ...
  ModuleConfig_TAKConfig._() : super();
  factory ModuleConfig_TAKConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ModuleConfig_TAKConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModuleConfig.TAKConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..e<$1.Team>(1, _omitFieldNames ? '' : 'team', $pb.PbFieldType.OE, defaultOrMaker: $1.Team.Unspecifed_Color, valueOf: $1.Team.valueOf, enumValues: $1.Team.values)
    ..e<$1.MemberRole>(2, _omitFieldNames ? '' : 'role', $pb.PbFieldType.OE, defaultOrMaker: $1.MemberRole.Unspecifed, valueOf: $1.MemberRole.valueOf, enumValues: $1.MemberRole.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $1.Team get team => $_getN(0);
  @$pb.TagNumber(1)
  set team($1.Team v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $1.MemberRole get role => $_getN(1);
  @$pb.TagNumber(2)
  set role($1.MemberRole v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ModuleConfig extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(14)
  set statusmessage(ModuleConfig_StatusMessageConfig v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set trafficManagement(ModuleConfig_TrafficManagementConfig v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasTrafficManagement() => $_has(14);
  @$pb.TagNumber(15)
  void clearTrafficManagement() => clearField(15);
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  set tak(ModuleConfig_TAKConfig v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasTak() => $_has(15);
  @$pb.TagNumber(16)
  void clearTak() => clearField(16);
  @$pb.TagNumber(16)

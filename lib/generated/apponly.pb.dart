...
class ChannelSet extends $pb.GeneratedMessage {
  factory ChannelSet({
    ...
    $3.Config_LoRaConfig? loraConfig,
  }) {
    final $result = create();
    if (settings != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ChannelSet', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..pc<$5.ChannelSettings>(1, _omitFieldNames ? '' : 'settings', $pb.PbFieldType.PM, subBuilder: $5.ChannelSettings.create)
    ..aOM<$3.Config_LoRaConfig>(2, _omitFieldNames ? '' : 'loraConfig', subBuilder: $3.Config_LoRaConfig.create)
  ...
  ///  LoRa config
  @$pb.TagNumber(2)
  $3.Config_LoRaConfig get loraConfig => $_getN(1);
  @$pb.TagNumber(2)
  set loraConfig($3.Config_LoRaConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasLoraConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearLoraConfig() => clearField(2);
  @$pb.TagNumber(2)
  $3.Config_LoRaConfig ensureLoraConfig() => $_ensure(1);
}

...
class MeshtasticConfigWrapper {
  ...
  int? get onBatteryShutdownAfterSecs =>
  ...
  int? get externalNotificationOutputMs => externalNotificationConfig?.outputMs;
  ...
  int? get storeForwardHistoryReturnMax => storeForwardConfig?.historyReturnMax;
  ...
  bool get detectionSensorSendBell => detectionSensorConfig?.sendBell ?? false;
